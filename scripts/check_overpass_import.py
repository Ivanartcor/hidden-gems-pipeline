...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Comprueba el resultado del import canónico de OSM Overpass en la base de datos."
    )

    parser.add_argument(
        "--source-code",
        type=str,
        default="osm_overpass",
        help="source_code a comprobar. Por defecto: osm_overpass.",
    )
...
def main() -> int:
    ...
    with engine.connect() as connection:
        ...
        sample_places = fetch_rows(
            ...
            JOIN (
              ...
              ON linked_places.place_id = p.place_id
            ORDER BY p.place_confidence DESC NULLS LAST, p.canonical_name
            LIMIT 20
            """,
            params,
        )
    ...
    logger.info("Comprobación del import canónico Overpass completada correctamente.")
