...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Ejecuta la deduplicación intra-fuente sobre candidatos "
            "de Google Places ya transformados."
        )
    )
    ...
    source_group.add_argument(
        "--staging-dir",
        type=str,
        help="Ruta directa al directorio staging generado por transform_google_places_candidates.",
    )
    source_group.add_argument(
        "--raw-asset-id",
        type=str,
...
def main() -> int:
    ...
    logger.info("Deduplicación Google Places completada correctamente.")
